...
def define_keras_flags():
  ...
  flags.DEFINE_string(
      ...
      help='Save profiling data to model dir at specified range of steps. The '
      'value must be two integers, the start step number and the stop step '
      'number, seperated by one comma. For example, "--profile_steps=2,4" '
      'triggers the profiler to profile 3 steps, starting from the 2nd. '
      'Note that profiler has a performance overhead, and the output file can '
      'be gigantic if profiling many steps.')
